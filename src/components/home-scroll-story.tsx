        ...
        <Reveal className="band-black" threshold={0.15} rootMargin="-10%">
          ...
          <div className="contact-final-links">
            ...
            <a href="https://wa.me/447342620366" className="contact-final-link pt-0.5" target="_blank" rel="noopener noreferrer">
              ...
              <span className="btn-whatsapp inline-flex items-center gap-2 rounded-full px-6 py-4 sm:px-5 sm:py-2 text-sm font-bold uppercase tracking-wider" style={{ background: '#8FEA64', color: '#050607' }}>
                Message us now ↗
              </span>
            </a>
