...
const serviceCards = [
  ...
  { icon: 'search' as const, title: 'SEO & AI Search', desc: 'Get found by the people searching for what you do. Local SEO, national SEO, technical audits.', roles: ['Keyword strategy', 'Technical SEO', 'Local search', 'Content planning', 'Microsites', 'Data insights'], roleLabel: 'Includes' },
